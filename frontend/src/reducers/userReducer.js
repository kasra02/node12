import {USER_LOGIN_REQUEST,USER_LOGIN_SUCCESS,USER_LOGIN_FAIL,USER_LOGOUT,
    ...
    USER_DETAIL_SUCCESS,USER_DETAIL_FAIL,USER_DETAIL_REQUEST,
...
export const userRegisterReduccer = (state={},action) => {
    switch (action.type) {
...
export const userDetailsReduccer = (state={user:{}},action) => {
    switch (action.type) {
